...
export const nonLottoTeams = [
  ...
  { id : 12, team: 'ShOwBoAtS .', byWayOf: 'By way of Mamba Forever', image: '' },
]
...
export const lotteryTeams = [
  ...
  { name: 'LOADING...', record: 'Regular Season Record: (51-102)', odds: 35, order: 1, image: '/assets/loading.gif'  }
]

export const lottoTeams = [
  //record instead of byWayOf?
  { id: 1, team: '', record: '', image: '' },
  { id: 2, team: '', record: '', image: '' },
  { id: 3, team: '', record: '', image: '' },
  { id: 4, team: '', record: '', image: '' },
  { id: 5, team: '', record: '', image: '' },
  { id: 6, team: '', record: '', image: '' }
]